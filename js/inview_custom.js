...
$('.regular_text_left, .regular_text_right, .list-items div, .center_phone, .feature-list, .features .title, .features a, .underline-p, .close-up .title, .landscape-phone, .gallery .title, .vendor_overview .title, #gallery-images, .newsletter .title, .work .title, .newsletter form, .footer .logo *').css('opacity','0');
...
// ************************ //
      $('.gallery .title, .vendor_overview .title').one('inview', function (event, visible) {
    if (visible) {   $(this).addClass('animated fadeInRight delayp2');   }});
